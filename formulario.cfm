				...
				<div class="row">
    				...
    				<cfif IsDefined('URL.id_empleado')>
    					...
    					<cfquery name="consulta_registro" datasource="fingresos">
							select empleado, fecha, torre1,torre2,torre3,torre4,torre5  from registros		
							where empleado = #url.id_empleado# 
							and fecha = #consulta#
						</cfquery>
							...
							<div class="row">
					    		<div class="col-sm-12">
					    			<div class="col-sm-12 alert alert-success">
					    				<cfset dia=Lsdateformat(#consulta_registro.fecha#,"dd/mm/yyyy")>
						               	<p>Registro realizado anteriormente el dia #dia#</p>                              
						            </div>      					
					    		</div>
					    	</div>
					    	<div class="frorm-group">
			              		<form name="registro" action="temperatura_action.cfm" method="post" enctype="multipart/form-data">    	
							    	<div class="row">
							    		<div class="col-sm-8">
								    		<table border="0" cellpadding="0" cellspacing="0" class="table table-bordered">									
												...
												<tr>
													...
													<cfquery name="temperatura" datasource="fingresos">
														select empleado, fecha, torre1, temperatura1   from registros		
														where empleado = #url.id_empleado# 
														and fecha = #consulta#
													</cfquery>
													<td  align="center"><input type="text" id="temperatura2" class="form-control"  name="temperatura2" <cfif #temperatura.temperatura1# neq '0'>value="#temperatura.temperatura1#" readonly <cfelse><cfif #session.id# eq 2>required<cfelse>readonly</cfif></cfif> ></td>
												</tr>
												<tr>
													<td  align="center" width="80%">Edificio Insurgentes</td>
													<cfquery name="temperatura2" datasource="fingresos">
														select empleado, fecha, torre2, temperatura2 from registros		
														where empleado = #url.id_empleado# 
														and fecha = #consulta#
													</cfquery>
													<td  align="center"><input type="text" id="temperatura3" class="form-control"  name="temperatura3" <cfif #temperatura2.temperatura2# gt '0'>value="#temperatura2.temperatura2#" readonly <cfelse><cfif #session.id# eq 3>required<cfelse>readonly</cfif></cfif> ></td>														
												</tr>
												<tr>	
													<td  align="center" width="80%">Edificio Picacho</td>
													<cfquery name="temperatura3" datasource="fingresos">
														select empleado, fecha, torre3, temperatura3 from registros		
														where empleado = #url.id_empleado# 
														and fecha = #consulta#
													</cfquery>
													<td  align="center"><input type="text" id="temperatura4" class="form-control"  name="temperatura4" <cfif #temperatura3.temperatura3# gt '0'>value="#temperatura3.temperatura3#" readonly <cfelse><cfif #session.id# eq 4>required<cfelse>readonly</cfif></cfif> ></td>													
												</tr>
												<tr>
													<td  align="center" width="80%">Torre Tecamachalco</td>
													<cfquery name="temperatura4" datasource="fingresos">
														select empleado, fecha, torre4, temperatura4 from registros		
														where empleado = #url.id_empleado# 
														and fecha = #consulta#
													</cfquery>
													<td  align="center"><input type="text" id="temperatura5" class="form-control"  name="temperatura5" <cfif #temperatura4.temperatura4# gt '0'>value="#temperatura4.temperatura4#" readonly <cfelse><cfif #session.id# eq 5>required<cfelse>readonly</cfif></cfif> ></td>													
												</tr>
												<tr>	
													<td  align="center" width="80%">N&uacute;cleo Morelia y Frontera</td>
													<cfquery name="temperatura5" datasource="fingresos">
														select empleado, fecha, torre5, temperatura5  from registros		
														where empleado = #url.id_empleado# 
														and fecha = #consulta#
													</cfquery>													
													<td  align="center"><input type="text" id="temperatura6" class="form-control"  name="temperatura6" <cfif #temperatura5.temperatura5# gt '0'>value="#temperatura5.temperatura5#" readonly <cfelse><cfif #session.id# eq 6>required<cfelse>readonly</cfif></cfif> ></td>
												</tr>	
											</table>
										</div>
							  		</div>
    					...
    					<cfelse>
	    					<div class="frorm-group">
			              		<form name="registro" action="formulario_action.cfm" method="post" enctype="multipart/form-data">
						    		<div class="col-sm-12">
						    			<cfset consulta = LSDateFormat(now(), "dd/mm/yyyy")>
						    				<cfquery name="consulta_registro" datasource="fingresos">
												select empleado, fecha, torre from registros		
												where empleado = #url.id_empleado# 
												and fecha = #consulta#
											</cfquery>										
											<div class="row">
